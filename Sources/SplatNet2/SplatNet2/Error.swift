...
//    enum Response.APIError: Response.APIError, Identifiable, CaseIterable {
...
//
//
//extension SplatNet2.Response.APIError: LocalizedResponse.APIError {
